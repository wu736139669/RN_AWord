  ...
  render() {
    return (
      <TabBarNavigator
        ...
        <TabBarNavigator.Item title='首页' icon={require('./bottom_ic_first_up.png')} defaultTab>
          <HomePage/>
        </TabBarNavigator.Item>
        <TabBarNavigator.Item title='随机' icon={require('./bottom_ic_first_up.png')}>
          <RandPage/>
        </TabBarNavigator.Item>
        <TabBarNavigator.Item title='收藏' icon={require('./bottom_ic_first_up.png')}>
          <CollectPage/>
        </TabBarNavigator.Item>
        <TabBarNavigator.Item title='测试' icon={require('./bottom_ic_first_up.png')}>
          <MyListViewDemo/>
        </TabBarNavigator.Item>
      </TabBarNavigator>
    );
